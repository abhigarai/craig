...
public class Query3 {
		...
		public void map(LongWritable key, Text value,
			...
			if (!currentLine.isEmpty()) {
				...
				try {
					...
					// get relevant information from each tweet
	...
	public static class Reduce extends MapReduceBase implements
		...
		/**
		 * Wrapper class implementing Comparable class to keep records sorted
		 * 
		 * @author Matt
		 *
		 */
		...
		public void reduce(Text key, Iterator<Text> values,
			...
			// hashmap to put records into separate buckets
			...
			// treesets to keep records sorted
			...
			// put each record into its bucket
			while (values.hasNext()) {
			...
			// take all records out of treeset
