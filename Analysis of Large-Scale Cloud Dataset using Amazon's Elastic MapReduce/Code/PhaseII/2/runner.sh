...
answer_3() {
	...
	sort -rnk1,1 output>temp1
        awk -F " " ' NR==1,NR==1{ print $2 } ' temp1
}
...
answer_4() {
	...
	sort -rnk1,1 output>temp2
        awk -F " " ' NR==1,NR==1{ print $1 } ' temp2
}
...
answer_5() {
	...
	javac Question5.java
        cat output | java Question5 $first $second
}
...
answer_8() {
	...
	javac Question8.java
        cat output | java Question8
}
