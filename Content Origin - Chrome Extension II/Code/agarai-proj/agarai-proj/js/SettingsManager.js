...
This is a general purpose Settings manager script which manages the chrome extension
and provides the necessary permissions to allow the extension with the
security permissions, download permissions, event listener 
and to the chrome permissions such as tabs, local storage etc. based on the 
OS whether it is Windows or Linux.
